...
from verification.reports import feedback_weight_sensitivity
from verification.reports import summarize_outcomes
from verification.reports import verify_recommendations
from verification.workflows import evaluate_recommendations
...
def build_feedback_argv(args: argparse.Namespace) -> list[str]:
    return [
        "--alert-csv",
        str(THEME_OUTDIR / "alert_tracking.csv"),
        "--weights",
        str(args.weights),
        "--out",
